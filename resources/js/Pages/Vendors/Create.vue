    ...
    <div class="container-fluid p-0">
        ...
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>CREATE</strong> VENDOR</h3>
            </div>
        </div>
                        ...
                        <form @submit.prevent="storeVendor">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input  v-model="form.vendor_name" class="form-control" name="vendor_name" placeholder="Vendor Name">
                            ...
                            <div class="row mb-2 mb-xl-3">
                                ...
                                <div class="col-auto d-none d-sm-block">
                                    <Link :href="'/vendors'" class="btn btn-outline-primary"><font-awesome-icon icon="fa-solid fa-backward" /> Back
                                    </Link>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content bg-light">
                                            <div class="modal-body m-3 text-center">
                                                ...
                                                <h3 class="m-2">
                                                    <span>Are you sure! do you want to Create this Vendor ?</span></h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            storeVendor() {
                this.$inertia.post('/vendors', this.form)
            },
        },
    }
</script>
